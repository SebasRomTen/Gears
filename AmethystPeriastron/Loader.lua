...
local amethyst_periastron = Instance.new("Tool")
amethyst_periastron.Grip = CFrame.fromMatrix(Vector3.new(0, 0, -2), Vector3.new(0, 1, 0), Vector3.new(0, 0, 1), Vector3.new(1, 0, 0))
amethyst_periastron.GripForward = Vector3.new(-1, -0, -0)
amethyst_periastron.GripPos = Vector3.new(0, 0, -2)
amethyst_periastron.GripRight = Vector3.new(0, 1, 0)
amethyst_periastron.GripUp = Vector3.new(0, 0, 1)
amethyst_periastron.ToolTip = "Amethyst Annihilation"
amethyst_periastron.TextureId = "rbxassetid://93194689"
amethyst_periastron.WorldPivot = CFrame.fromMatrix(Vector3.new(-3.9300880432128906, 2.6200010776519775, 2.069999933242798), Vector3.new(0.7113149166107178, -0.7028734683990479, 3.072357657174507e-08), Vector3.new(0, -4.371138828673793e-08, -1), Vector3.new(0.7028734683990479, 0.7113149166107178, -3.109256141442529e-08))
amethyst_periastron.Name = "AmethystPeriastron"
amethyst_periastron.Parent = owner.Backpack

local animations = Instance.new("Folder")
animations.Name = "Animations"
animations.Parent = amethyst_periastron
...
handle.CFrame = CFrame.fromMatrix(Vector3.new(-14.726418495178223, 12.141582489013672, -14.259696960449219), Vector3.new(0.7113149166107178, -0.7028734683990479, 3.072357657174507e-08), Vector3.new(0, -4.371138828673793e-08, -1), Vector3.new(0.7028734683990479, 0.7113149166107178, -3.109256141442529e-08))
...
handle.Size = Vector3.new(1, 0.6000000238418579, 5.19999885559082)
handle.Name = "Handle"
handle.Parent = amethyst_periastron

local mesh = Instance.new("SpecialMesh")
mesh.MeshType = Enum.MeshType.FileMesh
mesh.MeshId = "http://www.roblox.com/asset/?id=80557857"
mesh.TextureId = "rbxassetid://93115151"
mesh.Parent = handle

local sparkles = Instance.new("Sparkles")
sparkles.Color = Color3.new(1.18056, 0, 1)
sparkles.SparkleColor = Color3.new(0.666667, 0, 1)
...
trail.Color = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.new(0.666667, 0, 1)), ColorSequenceKeypoint.new(1, Color3.new(0.666667, 0, 1))})
trail.Lifetime = 1
...
mouse_input.Parent = amethyst_periastron

local comet_ref = Instance.new("ObjectValue")
comet_ref.Name = "CometRef"
comet_ref.Parent = mouse_input

local creator = Instance.new("ObjectValue")
creator.Name = "Creator"
creator.Parent = mouse_input
...
normal_grip.Parent = amethyst_periastron

local Server = MisL.newScript("https://raw.githubusercontent.com/SebasRomTen/Gears/main/AmethystPeriastron/ServerS.lua", "server", amethyst_periastron)
Server.Name = "Server"

local Client = MisL.newScript("https://raw.githubusercontent.com/SebasRomTen/Gears/main/AmethystPeriastron/Client.lua", "local", amethyst_periastron)
Client.Name = "Client"

local MouseIcon = MisL.newScript("https://raw.githubusercontent.com/SebasRomTen/Gears/main/AmethystPeriastron/MouseIcon.lua", "local", amethyst_periastron)
