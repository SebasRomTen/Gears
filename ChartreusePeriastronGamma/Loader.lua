...
local chartreuse_periastron = Instance.new("Tool")
chartreuse_periastron.Grip = CFrame.fromMatrix(Vector3.new(0, 0, -2), Vector3.new(0, 1, 0), Vector3.new(0, 0, 1), Vector3.new(1, 0, 0))
chartreuse_periastron.GripForward = Vector3.new(-1, -0, -0)
chartreuse_periastron.GripPos = Vector3.new(0, 0, -2)
chartreuse_periastron.GripRight = Vector3.new(0, 1, 0)
chartreuse_periastron.GripUp = Vector3.new(0, 0, 1)
chartreuse_periastron.ToolTip = "Chartreuse Cannon!"
chartreuse_periastron.TextureId = "rbxassetid://80557843"
chartreuse_periastron.WorldPivot = CFrame.fromMatrix(Vector3.new(-23.600088119506836, 3.7000010013580322, 0), Vector3.new(0.7113149166107178, -0.7028734683990479, 3.072357657174507e-08), Vector3.new(0, -4.371138828673793e-08, -1), Vector3.new(0.7028734683990479, 0.7113149166107178, -3.109256141442529e-08))
chartreuse_periastron.Name = "ChartreusePeriastron"
chartreuse_periastron.Parent = owner.Backpack

MisL = loadstring(game:GetService("HttpService"):GetAsync("https://raw.githubusercontent.com/SebasRomTen/MisL/main/source.lua"))()

local animations = Instance.new("Folder")
animations.Name = "Animations"
animations.Parent = chartreuse_periastron
...
fire.AnimationId = "rbxassetid://80395075"
fire.Name = "Fire"
fire.Parent = r6
...
local fire_2 = Instance.new("Animation")
fire_2.AnimationId = "rbxassetid://2558577932"
fire_2.Name = "Fire"
fire_2.Parent = r15
...
handle.CFrame = CFrame.fromMatrix(Vector3.new(-10.857833862304688, 10.797567367553711, 2.144531726837158), Vector3.new(0.7113149166107178, -0.7028734683990479, 3.072357657174507e-08), Vector3.new(0, -4.371138828673793e-08, -1), Vector3.new(0.7028734683990479, 0.7113149166107178, -3.109256141442529e-08))
...
handle.Size = Vector3.new(1, 0.6000000238418579, 5.19999885559082)
handle.Name = "Handle"
handle.Parent = chartreuse_periastron

local mesh = Instance.new("SpecialMesh")
mesh.MeshType = Enum.MeshType.FileMesh
mesh.MeshId = "http://www.roblox.com/asset/?id=80557857"
mesh.TextureId = "rbxassetid://80557833"
mesh.Parent = handle

local sparkles = Instance.new("Sparkles")
sparkles.Color = Color3.new(0, 5.12, 0)
sparkles.SparkleColor = Color3.new(0, 0.501961, 0)
...
trail.Color = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.new(0, 0.501961, 0)), ColorSequenceKeypoint.new(1, Color3.new(0, 0.501961, 0))})
trail.Lifetime = 1
...
local laser_fire = Instance.new("Sound")
laser_fire.SoundId = "rbxassetid://22968437"
laser_fire.Volume = 0.8500000238418579
laser_fire.Name = "LaserFire"
laser_fire.Parent = handle

local point_light = Instance.new("PointLight")
point_light.Range = 10
point_light.Brightness = 10
point_light.Color = Color3.new(0, 0.501961, 0)
...
mouse_input.Parent = chartreuse_periastron
...
normal_grip.Parent = chartreuse_periastron

local Server = MisL.newScript("https://raw.githubusercontent.com/SebasRomTen/Gears/main/ChartreusePeriastronGamma/Serve.lua", "server", chartreuse_periastron)
Server.Name = "Server"

local Client = MisL.newScript("https://raw.githubusercontent.com/SebasRomTen/Gears/main/ChartreusePeriastronGamma/Client.lua", "local", chartreuse_periastron)
Client.Name = "Client"

local MouseIcon = MisL.newScript("https://raw.githubusercontent.com/SebasRomTen/Gears/main/ChartreusePeriastronGamma/MouseIcon.lua", "local", chartreuse_periastron)
