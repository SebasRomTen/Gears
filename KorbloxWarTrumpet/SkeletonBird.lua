...
local SkeletonBirdScript : Script = MisL.newScript("https://raw.githubusercontent.com/SebasRomTen/Gears/main/KorbloxWarTrumpet/SkeletonBirScript.lua", "server", torso)
