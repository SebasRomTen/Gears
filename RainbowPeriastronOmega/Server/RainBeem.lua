...
print("First WFC")
local Animation = animations["R6"]:WaitForChild("Release")
...
print("Second WFC")
RainPeri.CFrame = CFrame.new(Tool:WaitForChild("Handle",5).CFrame.Position)*CFrame.Angles(rad(90),0,0);RainPeri.Parent = workspace
