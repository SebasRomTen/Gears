...
vortex_bits.Enabled = false

local creatE = Instance.new("ObjectValue")
creatE.Name = "Creator"
...
creatE.Value = Player
effect.Parent = BlackHoleScript
particles.Parent = BlackHoleScript
creatE.Parent = BlackHoleScript
